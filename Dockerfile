...
# ✅ Copy full application after Composer runs
COPY . /var/www/html
...
# ✅ Ensure required writable directories exist with proper permissions
...
# ✅ Add entrypoint script to run install.php on startup
